...
struct LunchRotatingBoard: View {
            ...
            ZStack {
                ...
                Rectangle()
                    ...
                    .overlay() {
                        ...
                        let resultMenuString = "Lunch"+" "+lunchMenus[index]
                       // let _ = menuData.menuResultListUpdate(menuName: resultMenuString)
                        Text(resultMenuString)
